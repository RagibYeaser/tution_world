...
<!-- navigation -->
  <body id="root">
	...
	$query 	= "UPDATE student SET name='$name', gender='$gender', phone_no='$phone_no', email='$email', present_insti='$present_insti', medium='$medium', class='$class', present_district='$present_district', area='$area'  WHERE id=$id";
	...
	"<p>Record updated:<br> id=$id <br> name=$name <br> gender=$gender <br> phone_no=$phone_no <br> email=$email <br> present_insti=$present_insti <br> medium=$medium <br> class=$class <br> present_district=$present_district<br> area=$area <br> ";
