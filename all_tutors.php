    ...
    <div class="ui tablet computer only padded grid">
      <div class="ui borderless fluid small inverted menu">
        <div class="ui container">
          ...
          <a class="active item" href="all_tutors.php">ALL TUTORS</a>
...
<h1><center>All Tutor List</center></h1>
<h1><br></h1>
	...
	echo"<th>Name</th> <th>Gender</th> <th>Experience</th> <th>Email</th>  <th>PhoneNo</th> <th>From Institute</th> <th>District</th> <th>Area</th> <th>Interested Medium</th> <th>Interested Level</th>  <th>Expected Salary</th> <th>Joined date</th> \n";
	...
	while( $rows = mysqli_fetch_array( $results ) ) {
		...
		echo "<tr>";
			...
			echo "<td> $email</td>";
      echo "<td> $phone_no</td>";
			echo "<td> $From_institute</td>";
			echo "<td> $t_district</td>";
			echo "<td> $t_area</td>";
      echo "<td> $t_medium</td>";
			echo "<td> $interested_level</td>";
			echo "<td> $expected_salary</td>";
