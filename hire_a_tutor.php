...
<h2> <br> </h2>
      ...
      <div class="ui text container">
          <form class="ui form" method=POST action=hireAtutorResult.php>
  ...
  <p> -->
    ...
    <label>Select District</label>
              <div class="ui selection dropdown">
                <input type="hidden"name="t_district">
    ...
    <label>Medium</label>
              <div class="ui selection dropdown">
                <input type="hidden" name="t_medium">
                <i class="dropdown icon"></i>
    ...
    <label>For which class</label>
              <div class="ui selection dropdown">
                <input type="hidden" name="interested_level">
                <i class="dropdown icon"></i>
    ...
    <label>Expected experience</label>
              <div class="ui selection dropdown">
                ...
                <div class="menu">
                    ...
                    <div class="item" data-value="1 years">1 years</div>
                    <div class="item" data-value="2 years">2 years</div>
                    <div class="item" data-value="3 years">3 years</div>
                    <div class="item" data-value="4 years">4 years</div>
                </div>
            </div>
    ...
    <p>
      <label>Expected Tutor From </label>
              <div class="ui selection dropdown">
                <input type="hidden" name="From_institute">
                <i class="dropdown icon"></i>
                <div class="default text">choose institute</div>
                <div class="menu">
                    <div class="item" data-value="BUET">BUET</div>
                    <div class="item" data-value="DU">DU</div>
                    <div class="item" data-value="BRAC">BRAC</div>
                    <div class="item" data-value="UIU">UIU</div>
                    <div class="item" data-value="NSU">NSU</div>
                    <div class="item" data-value="AIUB">AIUB</div>
                </div>
            </div>
            <script src=
      ...
      <div class="ui stackable inverted divided equal height stackable grid">
        <div class="three wide column">
          ...
          <div class="ui inverted link list">
            ...
            <a href="special_offers.php" class="item">SPECIAL OFFERS</a>
          </div>
        </div>
        <div class="three wide column">
