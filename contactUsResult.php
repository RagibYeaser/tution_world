...
<!-- navigation -->
  <body id="root">
   ...
   <!-- <a class="right menu"></a>
     ...
     <div>
    <img class="ui centered image" src="contactUsResult.jpg"
     ...
     <!-- body php -->
<div>
<h3><center><i>Submitted Successfully</i></center></h3>
	<h1><center><i>We will Contact you soon.</i></center></h1>
...
$comment=$_GET["comment"];
	...
	$connect = mysqli_connect( HOST, USER, PASS, DB )
        ...
        mysqli_query( $connect, "INSERT INTO contactUs VALUES ('','$firstName', '$lastName', '$email', '$phoneNumber', '$comment','')")
